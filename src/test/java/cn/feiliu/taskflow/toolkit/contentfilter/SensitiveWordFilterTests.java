...
public class SensitiveWordFilterTests {
    static String content = "最近搞到一本黄色小说，《维奥莱特罗曼史》，作者马努里伯爵夫人，一个法国女人，\n"
                            ...
                            + "我的学问于我何用呢，大部分时间我用来轻视我演出的作品。她宣扬自己的女权观念时概括地说，就是不给其他任何人以权利对您说，"
                            + "我要。前一句对演艺界的无知风尚不无讽喻意味，后一句对女权主义观念的阐发简明而精当。\n"
    ...
    public static void main(String[] args) {
        String[] keywords = new String[] { "搞到", "性欲", "导引到大脑", "体力", "调情高手", "宜春香质", "肉蒲团", "伯爵夫人", "克里斯蒂昂巧妙", "如意君传",
                "维奥莱特罗曼史", "黄色小说", "雕塑家", "大仲马", "小仲马", "同性恋", "性器官", "肉体", "柏拉图", "多粗", "性交", "做爱", "主义", "享", "享受",
                "仅", "公投", "判断", "合", "培训", "大量", "奸", "强奸", "性感", "性欲", "性爱", "欲望", "激情", "狂", "联系", "色诱", "评", "骚" };
